...
| --- | --- | --- | --- | --- |
| `v1.18.18` / `31406ccc51b4bd2a4e1e086b2bcaa5f7f804f26d` | `dev-foreachcode-1.18.18` | `2a30041004a3145d679730c56e849034d480625c` | `opencode/docs/superpowers/specs/2026-08-15-01-product-branding-design.md` | 放宽验收：`dev` Portable 已真实构建、完成静态产物审计并通过启动 smoke；真实 `prod` 发布、完整 Windows 运行验收和额外供应链 hardening 留后续发布前处理。 |
